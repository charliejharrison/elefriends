...
def read_and_strip_lines(fi_name):
    """
    Return an array of the stripped lines in a file
    """
...
def load_data_and_labels():
    ...
    # positive_examples = read_and_strip_lines(POSITIVE)
    # negative_examples = read_and_strip_lines(NEGATIVE)
